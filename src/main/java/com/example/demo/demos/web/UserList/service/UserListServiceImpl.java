...
public class UserListServiceImpl implements UserListService {
    ...
    public List<UserList> findAll() {
        ...
        return jdbcTemplate.query(sql, new BeanPropertyRowMapper<>(UserList.class));
    }
    ...
    public UserList findById(Long id) {
        ...
        try {
            return jdbcTemplate.queryForObject(sql, new BeanPropertyRowMapper<>(UserList.class), id);
    ...
    @Override
    public List<UserList> findByNameOrProfession(String name, String profession) {
        ...
        return jdbcTemplate.query(sql.toString(), new BeanPropertyRowMapper<>(UserList.class), params.toArray());
    }

    @Override
    public List<UserList> findAllWithPagination(int pageNo, int pageSize, String sex, String profession, String name) {
        StringBuilder sql = new StringBuilder("SELECT * FROM userlist WHERE 1=1");
        List<Object> params = new ArrayList<>();
